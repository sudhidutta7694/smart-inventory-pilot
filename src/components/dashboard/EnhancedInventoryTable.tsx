...
const EnhancedInventoryTable = () => {
  ...
  const handleSaveProduct = (productData: Omit<Product, 'id'> | Product) => {
    if (modalMode === 'add') {
      ...
      toast({
        title: "Product Added",
        description: `${(productData as any).name} has been added to inventory.`,
      });
    } else {
      updateProduct(selectedProduct!.id, productData);
      toast({
        title: "Product Updated",
        description: `${(productData as any).name} has been updated.`,
      });
    }
  };
  ...
  const handleRegenerateData = async () => {
    ...
    toast({
      ...
      description: "AI insights and analytics have been updated based on current inventory.",
    });
  };
