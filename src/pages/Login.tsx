        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-muted rounded-lg">
            ...
            <div className="text-xs space-y-1">
              <p><strong>South Warehouse:</strong> admin1@supply.com / south123pass</p>
              <p><strong>East Warehouse:</strong> admin2@supply.com / east123pass</p>
            </div>
          </div>
        </CardContent>
      </Card>
